...
export default function CommandBar(props) {
  ...
  const actionsBySection = {
    General: [
      ...
      },
      {
        ...
        iconData: sourceIcon,
        perform: () => {
          window.open('https://github.com/nikitadesale', '_blank');
          setOpen(false);
        },
        iconId: 'source'
      }
    ...
    'Go To': [
      ...
      },
      {
        id: 'credits',
        name: 'Credits',
        shortcut: shortcutCombos.credits,
        keywords: 'go-credits',
        section: 'Go To',
        iconData: aboutIcon,
        perform: () => {
  ...
  useHotkeys(shortcutCombos.work.join('>'), () => actionsById.work.perform());
  useHotkeys(shortcutCombos.uses.join('>'), () => actionsById.uses.perform());
  useHotkeys(shortcutCombos.credits.join('>'), () =>
    actionsById.credits.perform()
  );

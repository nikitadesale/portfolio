  ...
  const renderIntro = () => {
    return (
      <div className="flex flex-col justify-between md:flex-row">
        <div className="relative mt-0 aspect-square w-full max-w-84 shrink-0 overflow-hidden rounded-lg md:w-84">
          <Image
            alt="Professional headshot of Nikita Desale, AI and Cloud Engineer."
        ...
        <div className="mt-0 w-auto md:w-[48%]">
          <p className="mt-4 md:my-3.75 md:-mt-1.5">
            <strong>Hey, I&apos;m Nikita Desale</strong> — an AI & Cloud
            Engineer at <strong>Searce</strong>, working on agentic systems,
            GCP/AWS platforms, and production ML workflows.
          </p>
          ...
          <p className="md:my-3.75">
            ...
            CSU East Bay (expected 2026). Outside of work I like digging into
            new models, infra tooling, and clear technical writing.
          </p>
        </div>
      </div>
    );
      ...
      <div>
        ...
        <div className="flex items-center">
          ...
          <ButtonPrimary
            ...
            download="nikita-desale-headshot.png"
            className="inline-flex items-center justify-center"
